...
<main class="p-4">
        ...
        <div class="col-md-12 d-flex justify-content-between">
            <div class="link-secondary">
                <h4 class="font-weight-bold">
                    ...
                    > Constancias de Trabajo > Egresados</h4>
            </div>
    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" class="btn btn-light btn-sm" data-toggle="modal" data-target="#modalHelpEgresado">
    ...
    <div class="modal fade" id="modalHelpEgresado" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Ayuda</h1>
                ...
                <div class="modal-body" style="text-align: justify;">
                    <p class="fs-5">
                        En esta sección, puedes generar una <strong>constancia de egreso</strong> para trabajadores que ya no laboran en la institución.
                    </p>
                </div>
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 404 || xhr.status === 500) {
                    mensajeError = "Persona no encontrada en SIGEFIRRHH como Egresado.";
