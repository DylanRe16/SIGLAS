<div class="card card-outline card-primary shadow-sm">
    <div class="card-header bg-light">
        <h3 class="card-title text-bold"><i class="fas fa-user mr-2 text-primary"></i> Información del Trabajador</h3>
    </div>
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row mt-2">
                    ...
                    <div class="col-md-4"><strong>RIF:</strong><br> {{ $trabajador->srif ?? 'N/A' }}</div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-4"><strong>Correo:</strong><br> {{ $trabajador->correoelectronico ?? 'N/A' }}</div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <strong>Ubicación:</strong><br>
                        {{ $trabajador->parroquia_descripcion }}, {{ $trabajador->municipio_descripcion }}, {{ $trabajador->ciudad_descripcion }}
                    </div>
                </div>
            </div>
        </div>
