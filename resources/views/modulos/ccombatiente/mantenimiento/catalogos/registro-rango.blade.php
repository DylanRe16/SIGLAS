...
@section('content')
<main class="p-4">
    @include('layouts.modals.ccombatiente.modal_rango')
            ...
            <form action="{{ isset($editRegistro) ? route('registro-rango-editar', $editRegistro->id_rango) : route('registro-rango-crear') }}" method="POST">
                ...
                <div class="row fs-6 d-flex align-items-end mb-4">
                    <div class="col-md-10">
                        ...
                        <input type="text" tabindex="9" class="form-control" placeholder="Ingrese..." name="rango" id="rango" value="{{ old('rango', isset($editRegistro) ? $editRegistro->sdescripcion : '') }}" required>
                    </div>
