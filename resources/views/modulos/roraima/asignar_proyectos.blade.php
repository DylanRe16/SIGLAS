...
@section('title', 'Roraima - Asignar Proyectos')
    ...
    <div class="row">
        <div class="col-md-12 d-flex justify-content-between">
            <div class="link-secondary">
                <h4 class="font-weight-bold">Asignar Usuarios > Asignar Proyectos</h4>
            </div>
            ...
            <div class="row fs-6 d-flex align-items-end mb-4">
                <div class="col-md-5">
                    ...
                    <select id="rol" class="form-select select2" style="border-radius: 30px;">
						...
						<!-- <option value="49">Encargaduría</option> -->
						<!-- <option value="28">Jubilado / Pensionado</option> -->
						<option value="29">Secretaria</option>
						<!-- <option value="11">Usuario Activo</option> -->
						<!-- <option value="37">Administrador BD</option> -->
                    </select>
                </div>
                ...
                <div class="col-md-7 d-flex justify-content-center gap-2">
                    ...
                    <!-- <button class="btn btn-danger px-4" onclick="ejecutarAccion(3)">Inhabilitar</button> -->
                </div>
            </div>
        </div>
    </div>
