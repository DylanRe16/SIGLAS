...
@section('content')
<main class="p-4">
    <form action="{{ route('formatos-notificacion-ausencia-generarpdf') }}" method="POST" id="form-pdf">
    <div class="row">
...
{{-- <div class="card card-primary">
             ...
             <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <label class="link-secondary ">Ubicación Física<span class="text-danger">*</span></label>
                                <input type="text" name="ubicacion" id="ubicacion" class="form-control form-control-ovalado" value="{{ old('ubicacion') }}" placeholder="Ingrese...">
                                 @error('ubicacion')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                <div class="form-group">
                                    <label class="link-secondary ">Cargo o Puesto de Trabajo Que Ejerce <span class="text-danger">*</span></label>
                                    <input type="text" name="cargo_puesto_trabajo" id="cargo_puesto_trabajo" class="form-control form-control-ovalado" value="{{ old('cargo_puesto_trabajo') }}" placeholder="Ingrese...">
                                    @error('cargo_puesto_trabajo')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        </div>
 ...
 {{-- Contenedor para Alerta General (opcional, si quieres resumen arriba) --}}
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title font-weight-bold">Especificaciones de la Ausencia</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#modal1">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" id="nombre" maxlength="45" class="form-control form-control-ovalado @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="Ingrese...">
                        @error('nombre')
                            <small class="text-danger error-msg">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="director" id="director" maxlength="45" class="form-control form-control-ovalado @error('director') is-invalid @enderror" value="{{ old('director') }}" placeholder="Ingrese...">
                        @error('director')
                            <small class="text-danger error-msg">{{$message}}</small>
                        @enderror
                    </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" style="height: auto;">    
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: justify;">
                    <p>En esta sección, puedes generar una <strong>Notificación de Ausencia</strong> para un empleado.</p>
