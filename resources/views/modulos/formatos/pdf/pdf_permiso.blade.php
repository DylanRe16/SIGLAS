...
<div class="container">
    ...
    <tr>
        <th colspan="2" class="header-section" style="font-size: 12pt; padding: 8px;">SOLICITUD DE PERMISO</th>
    ...
    <tr>
        <th colspan="3" class="header-section">Especificaciones del Permiso</th>
    </tr>
