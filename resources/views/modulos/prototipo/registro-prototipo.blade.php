        ...
        <div class="content-login">
            ...
            <div class="col-sm-6 caja2">
                <div class="card card-body caja-body">
                    ...
                    <form action="{{route('registro-proto-prueba')}}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" style="display: flex;justify-content: center;flex-direction: column;">
                                <center>
                                    ...
                                    <input maxlength="8" tabindex="9" class="form-control num_certif" aria-label="Es obligatorio indicar su Nro. de documento" 
                                        type="text" style="width: 100%;" placeholder="Nro. de documento" name="ced_afiliado" id="ced_afiliado"  
                                        value="{{ old('ced_afiliado') }}">

                                        <span style="width: 100px; background-color: #fff"></span>
                                    </div>

                                    <div class="sep"></div>

                                    <div class="input-group">
                                        <input maxlength="20" tabindex="9" class="form-control num_certif" aria-label="Es obligatorio indicar el Nro. De Boleta" type="text" style="width: 80%; max-width: 210px" placeholder="Nro. de Boleta" name="boleta" id="nro_boleta"  value="{{ old('nro_boleta') }}">
