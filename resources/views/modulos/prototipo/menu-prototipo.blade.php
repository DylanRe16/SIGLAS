<aside class="sidebar">
    <header class="sidebar-header">
        <a href="{{route('inicio')}}" class="header-logo">
            ...
            <div class="user-name">
                {{ Auth::user()->sprimer_nombre ?? 'Nombre' }} {{ Auth::user()->sprimer_apellido ?? 'Apellido' }}
            </div>
        </a>
    ...
    <nav class="sidebar-nav">
        <ul class="nav-list primary-nav">
            <li class="nav-item dropdown" id="miPerfilDropdown">
                <a class="nav-link" href="#" role="button" id="miPerfilToggle">
                    <span class="nav-icon material-symbols-rounded">account_circle</span>
                    <span class="nav-label">MI PERFIL</span>
                </a>
                <span class="nav-tooltip">MI PERFIL</span>
                <ul class="dropdown-menu dropdown-menu-dark" id="miPerfilMenu">
                    <li><a class="dropdown-item" href="{{ route('datoPersonal-prototipo') }}">Datos Personales</a></li>
                    <li><a class="dropdown-item" href="{{ url('contraseña4-prototipo') }}">Cambiar contraseña</a></li>
                    <li><a class="dropdown-item" href="{{ url('preguntas-seguridad-prototipo') }}">Preguntas de seguridad</a></li>
                    
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="miSolicitudesToggle">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" id="miSolicitudesMenu">
                    <li><a class="dropdown-item" href="{{ route('productiva') }}">Gestión Productiva</a></li>
                    <li><a class="dropdown-item" href="{{ route('informe') }}">Informes</a></li>
                    <li><a class="dropdown-item" href="{{ route('exp_productiva') }}">Experiencia Cienfitica Productiva</a></li>
                </ul>
            </li>
            <li class="nav-item">
                <a href="{{ asset('pdfs/tu_archivo_de_ayuda.pdf') }}" class="nav-link" target="_blank">
                    <span class="nav-icon material-symbols-rounded">account_circle</span>
            ...
            <li class="nav-item">
    <a href="{{ route('prototipo.index') }}" class="nav-link">
...
<style>
    ...
    .user-name {
        ...
        font-weight: normal;
        color: #F0F0F0;
        margin-right: 35px; /* Espacio entre el nombre y el botón de expansión */
        text-decoration: none; /* Evita subrayados */
        transition: text-shadow 0.3s ease; /* Transiciones suaves */
    }
    ...
    .user-name:hover {
        ...
        margin-right: 35px; /* Espacio entre el nombre y el botón de expansión */
        text-decoration: none; /* Evita subrayados */
        cursor: pointer; /* Asegura que no actúe como un enlace */
    }
    ...
    .sidebar.collapsed .nav-item .nav-tooltip {
        display: none; /* Ocultar por defecto en el estado colapsado */
        position: absolute;
        top: 50%;
        left: 100%; /* Mostrar a la derecha del icono */
        transform: translateY(-50%);
        background-color: white; /* Fondo blanco */
        color: #004B9D; /* Texto azul */
        padding: 5px 10px;
        border-radius: 4px;
        font-size: 12px;
        white-space: nowrap;
        ...
        margin-left: 10px; /* Espacio entre el icono y el tooltip */
        border: 1px solid #ccc; /* Añadimos un borde sutil para mejor contraste */
    }
    ...
    .sidebar.collapsed .nav-item .nav-label {
        display: none; /* Ocultar el texto del label cuando está colapsado */
    }
</style>
